...
const Card = ({name, address, phone, email}) => {
    return (
    <div className="bg-primaryBlue border-2 w-auto rounded-lg m-5 h-48 shadow-inner p-5 hover:scale-[1.03] transition-all flex flex-nowrap justify-evenly flex-initial flex-row">
